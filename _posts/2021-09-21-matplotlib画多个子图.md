---
layout: post
title: 数学建模｜matplotlib画多个子图
categories: [数学建模]
description: 【数学建模相关】matplotlib画多个子图(散点图+ 拟合曲线 线性，二次，指数 求 可决系数r^2)
keywords: 编程语言, 数学建模
mermaid: false
sequence: false
flow: false
...
### 例图
![Alt Text](/images/posts/fd50833f6be2456f9f3562aaa23bfdb2.png)
### 代码展示
...
![Alt Text](/images/posts/dca6ea5e524c4b178300678e0e6ac826.jpg)
